...
(function (c) {
    c.toast = function (b) {
        var d = c("body"); b.container && 1 === b.container.length && (d = b.container); d.children(".toast-container").length || (d.prepend('<div class="toast-container" aria-live="polite" aria-atomic="true"></div>'), d.children(".toast-container").append('<div class="toast-wrapper"></div>'), d.on("hidden.bs.toast", ".toast", function () { c(this).remove() })); d = d.children(".toast-container").children(".toast-wrapper"); var k = "toast-" + (c(".toast").length + 1), a = "", f = a = "", g = "text-muted", h = "", r = b.title ||
